...
interface ILayerZeroEndpoint is ILayerZeroUserApplicationConfig {
    ...
    // address length/format may vary by chains
    ...
    // @param _adapterParams - parameters for custom functionality. e.g. receive airdropped native gas
    // from the relayer on destination
    function send(
        uint16 _dstChainId,
